...
#
# checker = Checker(db_path, CMinerParser(solutions_path), matching_algorithm="MultiGraphMatch")
#
# checker.isomorphic_solutions()
#

gpsan_parser = CMinerParser("/Users/simoneavellino/Desktop/CMiner/test/solution/sol.data")
